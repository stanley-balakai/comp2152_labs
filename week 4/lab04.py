...
print(f"The monster has rolled {monster_power} and its combat strength is now {m_combat_strength}")
...
for _ in range(2):
    ...
    print(f"You have collected: {loot_item}")
    print(f"Current belt items: {belt}")

# Organizing the loot belt
print("Organizing your belt...")
belt.sort()
print(f"Organized belt items: {belt}")

# Use the first loot item
print("A monster appears in the distance! You can use the first item in your belt.")
used_loot = belt.pop(0)
if used_loot in good_loot_options:
    health_points = min(6, health_points + 2)
    print(f"You used {used_loot} and gained health! Your health is now {health_points}.")
elif used_loot in bad_loot_options:
    health_points = max(0, health_points - 2)
    print(f"You used {used_loot} and lost health! Your health is now {health_points}.")
else:
    print(f"You used {used_loot}, but it had no effect.")
print(f"Remaining belt items: {belt}")
